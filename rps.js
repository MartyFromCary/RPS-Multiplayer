...
const imagesRPS = {
    ...
    scissors: "https://media1.picsearch.com/is?dKwmDvH9LH873_IpmAkHG_BWWQ5vHVh4WHD8wON7wtc"
};

const emptyImage = "https://media1.picsearch.com/is?MCHR0iSPWmA1i6V4CZdJsyaMuPdJ4VLsPWP8Cm_-qZw";
...
function waitingForOpponent() {
    if ((dataRPS.Name1 !== dbContent.Name1) &&
...
$(document).ready(function() {
    ...
    classChoice.on('click', function() {
        ...
        if ((playObj.opponentName === dataRPS.Name1) &&
            (dataRPS.Choice0 === myUnset)) {
        ...
        if ((playObj.opponentName === dataRPS.Name0) &&
            (dataRPS.Choice1 === myUnset)) {
